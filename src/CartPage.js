...
const CartPage = () => {
    ...
    const handleSubmit = async(value)=>{
        try {
            ...
            await axios.post('https://order-management-backend-lge7.onrender.com/api/bills/add-bills',newObject)
  ...
  return (
    <DefaultLayout>
        ...
        <div className='d-flex flex-column align-items-end'>
            ...
            <Button style={{backgroundColor:"orange"}} onClick={()=>setBillPopup(true)}>create invoice</Button>
        </div>
